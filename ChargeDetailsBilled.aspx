<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.Master" AutoEventWireup="true" CodeBehind="ChargeDetailsBilled.aspx.cs" Inherits="FLOE.Admin.ChargeDetailsBilled" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header text-success"><a href="ChargeDetailsBilled.aspx" class="text-success">Billed > Charge Details</h1>
        </div>
        <!-- /.col-lg-12 -->  
    </div>
    ...
    <asp:Button style="font-size:11px"  runat="server" ID="btnGenerateReport" Text="Generate Report" OnClientClick="openwin();return false"></asp:Button>
