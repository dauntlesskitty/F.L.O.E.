<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.Master" AutoEventWireup="true" CodeBehind="ChargeDetailsChangeRequest.aspx.cs" Inherits="FLOE.Admin.ChargeDetailsChangeRequest" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header text-danger"><a href="ChangeRequestList.aspx" class="text-danger">Change Request List</a><i class="glyphicon glyphicon-chevron-right"></i>Charge Details</h1>
        </div>
        <!-- /.col-lg-12 -->  
    </div>
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" CssClass="gridview panel panel-default table table-striped" AllowSorting="True">
        <Columns>
            <%--<asp:TemplateField HeaderText="No." HeaderStyle-CssClass="danger" HeaderStyle-Width="50px">
                <ItemTemplate>
            ...
            <asp:BoundField DataField="Name_IC" HeaderText="Name" HeaderStyle-CssClass="danger" SortExpression="Name_IC" />

            <asp:TemplateField HeaderText="ID Charged" SortExpression="ID_Charged" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="danger">
                <ItemTemplate>
                    <asp:CheckBox ID="IDCharged" runat="server"></asp:CheckBox>
                </ItemTemplate>
            </asp:TemplateField>

            <asp:BoundField DataField="MfoService_Name" HeaderStyle-Width="80px" HeaderText="Service Name" SortExpression="MfoService_Name" HeaderStyle-CssClass="danger" ReadOnly="true"/>

            <asp:TemplateField HeaderText="Company to Bill" SortExpression="MfoCompany_Bill_To" HeaderStyle-CssClass="danger">
                <EditItemTemplate>
            ...
            <asp:TemplateField HeaderStyle-CssClass="warning" HeaderStyle-Width="120px" ControlStyle-CssClass="form-control content" HeaderText="Justification" SortExpression="Justification">
                <ItemTemplate>
                    <asp:TextBox ID="Justification" runat="server" Text='<%# Bind("Justification") %>'></asp:TextBox>
                </ItemTemplate>
            </asp:TemplateField>


            <asp:TemplateField HeaderText="Remarks" HeaderStyle-CssClass="success" ControlStyle-CssClass="form-control content" SortExpression="Remarks">
                <ItemTemplate>
                    <asp:TextBox ID="Remarks" runat="server" Text='<%# Bind("Remarks") %>'></asp:TextBox>
                </ItemTemplate>
            </asp:TemplateField>--%>
            ...
            <asp:BoundField DataField="Name_IC" HeaderText="Name" SortExpression="Name_IC" HeaderStyle-CssClass="danger" ReadOnly="true" ></asp:BoundField>
            ...
            <asp:TemplateField HeaderStyle-CssClass="danger" HeaderText="ID Charged" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Center">
                <%--<HeaderTemplate>
            ...
            <asp:BoundField DataField="MfoService_Name" HeaderText="Service Name" SortExpression="MfoService_Name" HeaderStyle-CssClass="danger" 
                ReadOnly="true">
            </asp:BoundField>
            ...
            <asp:TemplateField HeaderStyle-CssClass="danger" HeaderText="Justification" SortExpression="Justification">
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Approval">
                ...
                <HeaderStyle CssClass="danger" Width="120px" />
            </asp:TemplateField>

            <asp:TemplateField HeaderText="Remarks" SortExpression="Remarks" HeaderStyle-CssClass="danger">
                <ItemTemplate>
            ...
            <%--NONE USE DATA--%>
            <asp:BoundField DataField="ID_Name" HeaderText="Name"  SortExpression="ID_Name" Visible="false" />
    ...
    <asp:Button runat="server" ID="btnProceed" text="Proceed to Update Bill" ControlStyle-CssClass="btn btn-danger" OnClick="btnProceed_Click" />
    <asp:Button runat="server" ID="Button1" text="Feedback" ControlStyle-CssClass="btn btn-danger" OnClick="btnfeedBack_Click" /><br /><br /><br />
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:SDM_PUPMConnectionString1 %>" SelectCommand="SELECT [Company_Code],[Company_Name] as MfoCompany_Bill_To  FROM [PUPM_Master_Company]"></asp:SqlDataSource>
