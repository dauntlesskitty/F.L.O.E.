<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.Master" AutoEventWireup="true" CodeBehind="IDremoval.aspx.cs" Inherits="FLOE.Admin.IDremoval" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header text-warning">ID Removal Summary</h1>
        </div>
    </div>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" 
        ...
        <Columns>
             ...
             <asp:HyperLinkField DataNavigateUrlFields="payroll_Company" DataNavigateUrlFormatString="ChargeDetailedIDremoval.aspx?payroll_Company={0}&ServiceName=Internet" 
             ...
             <asp:HyperLinkField DataNavigateUrlFields="payroll_Company" DataNavigateUrlFormatString="ChargeDetailedIDremoval.aspx?payroll_Company={0}&ServiceName=Anti-Virus" 
             ...
             <asp:HyperLinkField DataNavigateUrlFields="payroll_Company" DataNavigateUrlFormatString="ChargeDetailedIDremoval.aspx?payroll_Company={0}&ServiceName=SmartCloud Mail" 
            ...
            <asp:HyperLinkField DataNavigateUrlFields="payroll_Company" DataNavigateUrlFormatString="ChargeDetailedIDremoval.aspx?payroll_Company={0}&ServiceName=HRMS" 
            ...
            <asp:HyperLinkField DataNavigateUrlFields="payroll_Company" DataNavigateUrlFormatString="ChargeDetailedIDremoval.aspx?payroll_Company={0}&ServiceName=Citrix" 
             ...
             <asp:HyperLinkField DataNavigateUrlFields="payroll_Company" DataNavigateUrlFormatString="ChargeDetailedIDremoval.aspx?payroll_Company={0}&ServiceName=eDMS/KP4" 
             ...
             <asp:HyperLinkField DataNavigateUrlFields="payroll_Company" DataNavigateUrlFormatString="ChargeDetailedIDremoval.aspx?payroll_Company={0}&ServiceName=Lotus Traveler" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SDM_PUPMConnectionString1 %>" 
        SelectCommand="PUPM_Select_Removal_ID_SummaryTest" SelectCommandType="StoredProcedure" >
        <SelectParameters>
